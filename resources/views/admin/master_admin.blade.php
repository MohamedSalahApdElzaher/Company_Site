...
<head>
    ...
    <link href="{{asset('backend/assets/plugins/nprogress/nprogress.cssassets/plugins/flag-icons/css/flag-icon.min.css')}}" rel="stylesheet" />
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="github-link mr-3">
                                <a class="btn btn-outline-secondary btn-sm" href="{{url('/')}}" target="_blank">
                                    <span class="d-none d-md-inline-block mr-2">Home Company</span>
                            ...
                            <li class="dropdown user-menu">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="dropdown-footer">
                                        <a href="{{route('userLogout')}}"> <i class="mdi mdi-logout"></i> Log Out </a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
